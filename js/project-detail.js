function initProjectDetail() {
  ...
  const populatePanel = (card) => {
    ...
    document.getElementById("project-panel-index").textContent =
      card.getAttribute("data-index") || "A—00";
    document.getElementById("project-panel-location").textContent =
      `${loc} — ${year}`;
    document.getElementById("project-panel-description").textContent =
      card.getAttribute("data-desc") || "";
    document.getElementById("project-panel-meta").innerHTML = `
